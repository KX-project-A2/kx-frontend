...
/** 홈 화면 프롬프트 제안 칩 -> presets_catalog.json category 매핑 (칩 라벨과 category 문구가 완전히 같지 않음) */
const SUGGESTION_CATEGORY_MAP: Record<string, string> = {
  '사이버펑크 도시의 밤': '사이버펑크 도시의 밤',
  '수채화 스타일 고양이': '수채화 스타일',
  '미니멀 제품 광고컷': '미니멀 제품 광고컷',
  '판타지 캐릭터 시트': '판타지 캐릭터',
  '시네마틱 풍경 영상': '시네마틱 풍경',
};
      ...
      <section className="flex flex-col items-center gap-6 pt-8 text-center">
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ background: 'var(--selected-bg)', border: '1px solid var(--selected-border)' }}
          >
